                ...
                <div className="container mx-auto px-4 sm:px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow sm:col-span-2 md:col-span-1 sm:max-w-xs sm:mx-auto md:max-w-none"
                        >
                            <div className="flex items-start justify-between mb-3 sm:mb-4">
                                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden border-2 border-purple-100">
